...
var FakeHashProvider_1 = __importDefault(require("@modules/users/providers/fakes/FakeHashProvider"));
...
describe('UpdateProfile', function () {
    ...
    it('should be able to update the profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    updatedUser = _a.sent();
                    expect(updatedUser === null || updatedUser === void 0 ? void 0 : updatedUser.name).toBe('John Fre');
                    expect(updatedUser === null || updatedUser === void 0 ? void 0 : updatedUser.email).toBe('john.fre@gmail.com');
                    return [2 /*return*/];
            }
        });
    }); });
    it('should not be able to update email to one already in use', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
    ...
    it('should not be able to update the profile without the old password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
    ...
    it('should not be able to update the profile with the old password wrong', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
    ...
    it('should not be able to update the profile is user is not found', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
