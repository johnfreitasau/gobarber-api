...
var ResetPasswordService = /** @class */ (function () {
    function ResetPasswordService(usersRepository, userTokensRepository, userHashProvider) {
        this.usersRepository = usersRepository;
        this.userTokensRepository = userTokensRepository;
        this.userHashProvider = userHashProvider;
    }
    ResetPasswordService.prototype.execute = function (_a) {
        var token = _a.token, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var userToken, user, tokenCreatedDate, compareDate, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        _b = user;
                        return [4 /*yield*/, this.userHashProvider.generateHash(password)];
                    case 3:
                        _b.password = _c.sent();
