...
var FakeUsersRepository = /** @class */ (function () {
    ...
    FakeUsersRepository.prototype.findAllProviders = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var users;
            return __generator(this, function (_a) {
                users = this.users;
                if (users) {
                    users = this.users.filter(function (user) { return user.id !== (data === null || data === void 0 ? void 0 : data.expect_user_id); });
                }
    ...
    FakeUsersRepository.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var findEmail;
            return __generator(this, function (_a) {
                findEmail = this.users.find(function (user) { return user.email === email; });
